...
public class GridBagLayout extends JFrame {
	...
	public GridBagLayout() {
		...
		lblNewLabel_1 = new JLabel("Apelido1");
		...
		lblNewLabel_2 = new JLabel("Apelido2");
		...
		lblNewLabel_3 = new JLabel("Observacions");
		...
		lblNewLabel_4 = new JLabel("Idade");
		...
		lblNewLabel_5 = new JLabel("Num fixo");
		...
		lblNewLabel_6 = new JLabel("Num mobil");
